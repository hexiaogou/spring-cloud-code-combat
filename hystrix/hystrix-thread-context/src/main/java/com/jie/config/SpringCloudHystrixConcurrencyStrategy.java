...
/**
 * @author hexiaogou
 * @classname SpringCloudHystrixConcurrencyStrategy
 * @description spring cloud hystrix concurrency strategy
...
public class SpringCloudHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {
    ...
    public <T> Callable<T> wrapCallable(Callable<T> callable) {
        return new HystrixThreadCallable<T>(RequestContextHolder.getRequestAttributes(), callable, HystrixThreadLocal.threadLocal.get());
    }
